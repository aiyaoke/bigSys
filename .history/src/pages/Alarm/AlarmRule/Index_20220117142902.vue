      ...
      <el-table :data="tableData" size="medium" :max-height="tableHeight">
        ...
        <el-table-column prop="desc" :label="$translate('名称')" align="center">
           ...
           <el-table-column prop="desc" :label="$translate('告警描述')" align="center">
               ...
               <el-table-column prop="desc" :label="$translate('每小时推送上限')" align="center">
        </el-table-column>

               <el-table-column prop="desc" :label="$translate('每日推送上限')" align="center">
        </el-table-column>

               <el-table-column prop="desc" :label="$translate('禁启用')" align="center">
        </el-table-column>
