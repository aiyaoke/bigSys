869+
66666666666666666696    786
+99999999999999999999999999999999999999999999999999999999999999999999999999999999<template>
    <div class="history-alarm">
        <div class="search-wrapper">
            <div>
                <span class="search-name">{{ $translate("开始日期") }}：</span>
                <el-date-picker
                    v-model="start"
                    size="mini"
                    type="date"
            ...
            <div>
                <span class="search-name">{{ $translate("结束日期") }}：</span>
                <el-date-picker
                    v-model="end"
                    size="mini"
                    type="date"
