<template>
  ...
  >
    ...
    <div class="item">
      ...
      <div
        :class="['payMethod', payMethod == 1 ? ' payMethodActive' : '']"
        @click="payMethod = 1"
      >
        <img src="./alipay.png" width="100" height="33" alt="" />
      </div>
      <div
        :class="['payMethod', payMethod == 2 ? ' payMethodActive' : '']"
        @click="payMethod = 2"
      >
        <img src="./wechart.jpg" width="137" alt="" />
      </div>
    </div>
    <div class="codeBox">
...
import wechart from "./wechart.png"
