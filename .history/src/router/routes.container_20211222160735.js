    ...
    children: [
      {
        ...
        component: _ =>
          import(
            /* webpackChunkName: "Overview" */ "@/pages/Overview"
          )
      },
      {
        path: "/system/monitor",
        ...
        component: _ =>
          import(
            /* webpackChunkName: "Overview" */ "@/pages/VideoMonitor"
          )
      },
      {
        ...
        children: [
          {
            ...
            component: _ =>
              import("@/pages/ElectricityAnalysis/RunMonitor")
          },
          {
            ...
            component: _ =>
              import("@/pages/EnergyManage/EnergyMonitor")
          }
        ]
      },
      {
        ...
        children: [
          {
            ...
            component: _ =>
              import("@/pages/EnergyManage/BatteryOverview")
          },
          {
            ...
            component: _ =>
              import("@/pages/EnergyManage/BatteryCluster")
          },

          {
            ...
            component: _ =>
              import("@/pages/StatistiReport/MaxPressure")
          },
          {
            ...
            component: _ =>
              import("@/pages/StatistiReport/TempCurve")
          },
          {
            ...
            component: _ =>
              import("@/pages/StatistiReport/VolCurve")
          }
        ]
      },
      {
        ...
        children: [
          {
            ...
            component: _ =>
              import("@/pages/ElectricityAnalysis/TerminalMeter")
          },
          {
            ...
            component: _ =>
              import(
                "@/pages/ElectricityAnalysis/ProfitStatistics"
              )
          },
          {
            ...
            component: _ =>
              import("@/pages/ElectricityAnalysis/ProfitDetail")
          },
          {
            ...
            component: _ =>
              import(
                "@/pages/ElectricityAnalysis/ElectricityStatistics"
              )
          }
        ]
      },
        ...
        children: [
          {
            ...
            component: _ =>
              import("@/pages/StationManage/PlantList")
          },
          {
            ...
            component: _ =>
              import("@/pages/StationManage/DeviceList")
          },
          {
            ...
            component: _ =>
              import("@/pages/EnergyManage/ControlStrategy")
          },
          {
            ...
            component: _ =>
              import("@/pages/EnergyManage/TimePrice")
          }
        ]
      },
      {
        ...
        children: [
          {
            ...
            component: _ =>
              import("@/pages/UserManage/PersonalInfo")
          },
          {
            path: "/system/userManage/myAccount",
            code: 'S',
            meta: {
              name: "增值业务"
            },
            component: _ =>
              import("@/pages/UserManage/"Value-Added Services",")
          },
          {
